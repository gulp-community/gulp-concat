...
To add a header with the name of each file, with any type of delimiter like a comment, add the function 'addHeaders' with the parameters 'fileName' and src:
...
```
This will concat the file name on top of every file as a comment for js or css into bundle.css. The delimiter can be anything in order to create comments for any type of files.
